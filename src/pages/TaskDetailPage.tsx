      ...
      <main className="mx-auto max-w-5xl px-6 py-10 space-y-8">
        <header className="space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs text-foreground/70">
            ...
            <span className="rounded-full border border-foreground/15 px-2 py-0.5">Citizen: {task.buyerName || task.buyerPhone || task.buyerId}</span>
            <span className="rounded-full border border-foreground/15 px-2 py-0.5">Superherooo: {task.helperName || task.helperPhone || task.assignedHelperId || '-'}</span>
